...
export default function Table({
  ...
  return (
    <div className="no-scrollbar overflow-hidden max-w-[85vw] md:max-w-[90vw] overflow-x-auto">
      <table className="w-full min-w-max text-sm text-white  border-spacing-[1.8rem] border-separate overflow-x-auto ">
            ...
            {tableHeaders.map((header) => {
              ...
              return (
                <th
                  ...
                  scope="col"
                  className={cn(
                    "py-[.4rem] text-left border-b-[1.5px] border-b-grey-50/[20%]",
                    header.className
                  )}
                >
