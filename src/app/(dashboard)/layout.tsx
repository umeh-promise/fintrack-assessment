...
export default function AdminLayout({
  ...
  return (
    <Wrapper className={cn({ "h-screen lg:h-auto": showMobileSidebar })}>
      ...
      <section className="h-full overflow-hidden  pb-[.8rem]  lg:gap-[4.8rem] text-grey-300 lg:grid xl:grid-cols-[32rem_1fr] lg:grid-cols-[28rem_1fr] md:pb-[8rem] [&>*]:pt-[2.2rem] lg:[&>*]:py-[2.8rem] ">
        <Sidebar
